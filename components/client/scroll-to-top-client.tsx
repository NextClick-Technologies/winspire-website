...
import { scrollToTop } from '@/lib/client/smooth-scroll'

/**
 * Client-side scroll-to-top button with show/hide on scroll
 * Displays when user scrolls past 300px threshold
 */
export function ScrollToTopClient() {
  ...
  const handleScrollToTop = () => {
    scrollToTop(0.05) // Very fast 0.05 second duration for instant feel
  }
