            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
              {categoryIcons.map((iconName) => {
                ...
                return (
                  ...
                  >
                    <div className="mb-2">
                      <SvgIcon name={iconName as IconName} size={48} className="mx-auto" />
                    </div>
                    <div className="text-center">
                      <p className="text-sm font-medium text-gray-900 mb-1">{metadata.name}</p>
                      <p className="text-xs text-gray-500 mb-1">{iconName}</p>
  ...
  return (
    <div className="p-6 space-y-8">
      <div>
        ...
        <p className="text-gray-600 mb-6">Different ways to use icons in your components.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <div className="flex items-center gap-4 mb-2">
              <SvgIcon name={Icons.SATISFACTION} size={32} className="opacity-50" />
              <SvgIcon
          ...
          <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-sm font-medium mb-3 text-red-800">
              Size priority (CSS overrides size prop):
            </p>
            <div className="flex items-center gap-4 mb-2">
              <SvgIcon
                name={Icons.ADVICE}
              ...
              <span className="text-sm text-red-700">
                CSS classes have higher priority than size prop
              </span>
            </div>
            <code className="text-xs bg-white px-2 py-1 rounded block">
