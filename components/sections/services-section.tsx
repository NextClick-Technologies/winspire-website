...
const bottomRow: Service[] = [
  ...
  {
    title: 'NDIS Certification audit (Stage 2)- Combined onsite and offsite',
    customIcon: 'INTERNET',
  },
  ...
  return (
    <section id="services" aria-labelledby="services-heading" className="relative bg-transparent">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-20 lg:px-12 z-10">
        ...
        >
          <SvgIcon name={Icons.OUR_MISSION} size={64} className="opacity-10 rotate-12" />
        </motion.div>
        <motion.div
        ...
        >
          <SvgIcon name={Icons.BUBBLE_BG} size={48} className="opacity-20" />
        </motion.div>
      ...
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-3/5 translate-y-1/6 bg-slate-50 z-0"
        aria-hidden="true"
      >
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <SvgIcon name={Icons.LIGHT_BULB} size={84} className="absolute -top-1/12 left-6 z-30" />
        </motion.div>
