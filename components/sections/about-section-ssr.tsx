      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:grid lg:grid-cols-2 lg:gap-12 lg:px-12 lg:py-24">
        ...
        >
          ...
          >
            ...
            Disability Insurance Scheme (NDIS). We deliver support through
            direct engagements, collaborations with healthcare providers, and
            referrals from NDIS and Community services.
          </motion.p>
