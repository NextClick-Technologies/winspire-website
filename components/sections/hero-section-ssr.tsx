...
export function HeroSectionSSR() {
  return (
    <motion.section
      id="hero"
      className="relative min-h-screen overflow-hidden z-0 transition-all duration-300 ease-out bg-[#001B6A0A]"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5 }}
    >
      {/* Hero Section */}
      <section className="relative z-20 px-6 lg:h-[calc(85dvh-1rem)] pt-36 pb-16 lg:translate-y-1/12">
        <div className="max-w-7xl h-full mx-auto grid lg:grid-cols-2 gap-6 lg:gap-12 items-center z-10">
          ...
          >
            ...
            >
              Holistic support services for NDIS participants and providers.
              Building capacity through compliance, operational excellence, and
              person-centred care.
            </motion.p>
