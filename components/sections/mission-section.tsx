        ...
        <div className='grid lg:grid lg:grid-cols-12 lg:gap-12 lg:px-12 lg:py-20 relative z-40'>
          ...
          >
            ...
            >
              ...
              Community Service providers, for the past two years. Our
              consulting team brings 7+ years of combined experience across
              compliance and risk analysis, operational advice, internal audit,
              and manager training. We work with providers of different sizes
              and needs, and we focus on building long‑term relationships that
